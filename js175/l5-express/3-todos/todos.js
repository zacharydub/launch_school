//session persistence - cookie (27-32,38) + deleting seed data importing (17-18) + set up persistent session data (42-49) + change all 'todoLists' references to req.session.todoLists + added makeToDo methods to both todo.js and todolist.js
//confirmation dialogs - js file in public folder + load it in layout.pug
...
// Set up persistent session data/initialize list of todolists
