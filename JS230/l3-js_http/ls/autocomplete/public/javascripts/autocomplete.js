////refactor old version to include:
//throttling XHR queries (so that we dont send an XHR query for every single typed letter) using 'debounce' module
//making the code reusable so we can use it for another input field in our app
