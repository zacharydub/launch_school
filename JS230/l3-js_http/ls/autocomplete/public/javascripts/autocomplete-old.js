const Autocomplete = {
  ...
  draw: function () {
    ...
    if (this.bestMatchIndex !== null && this.matches.length !== 0) {
      ...
      //this.overlay.textContent = selected.name; // this results in misaligned overlay vs user input, so we add a method for generating the overlay content that will adjust the display accordingly depending on the case of the letter input. Consequently, we will set the value of this.overlay.textContent to the return value of the method.
