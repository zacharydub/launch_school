//reduce size of createServer function by extracting the logic from the conditional branches to functions ('request handlers') that are invoked when those branches run
...
<html lang="en">
  ...
  <body>
    <article>
      <h1>Loan Calculator - Request Handlers </h1>
      <table>
        <tbody>
          <tr>
            <th>Amount:</th>
